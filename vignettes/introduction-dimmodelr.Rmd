...
vignette: >
  %\VignetteIndexEntry{Introduction to dimmodelR}
...
data they connect to are organized as [dimensional models](https://en.wikipedia.org/wiki/Dimensional_modeling). 

Dimensional models are typically derived from flat tables, which are split into 
"facts" and "dimensions". Fact tables contain columns to be aggregated or 
summarized (e.g. revenues or costs), whereas dimensions are used to group or 
filter the result.
...
While it is possible for these tools to process data from flat tables, a 
dimensional model performs better, scales better and is easier to extend with
unexpected new data.

<!-- # -->
<!-- ```{r echo=FALSE, fig.align='center', fig.cap='', out.width='10%'} -->
<!-- knitr::include_graphics('cve_linkedin.png') -->
<!-- ``` -->



<!-- ![Caption for the picture.](/vignettes/figures/README-pressure-1.png) -->
